...
if __name__ == '__main__':
    ...
    img_data, wave_data = default_build_vocab("./data/3.mkv", "./data/3.mp3")
    ...
    model = mx.model.FeedForward.load('model/lip', num_epoch, ctx=mx.context.gpu(0),
                                      num_epoch=550, learning_rate=0.5)
    import logging
